...
class UpdateBankAccountRequest extends FormRequest
{
    ...
    {
        return [
            'kode_bank' => 'sometimes|required|string|exists:banks,kode_bank',
            'nomor_rekening' => 'sometimes|required|string|min:8|max:20|regex:/^[0-9]+$/',
            'nama_pemilik' => 'sometimes|required|string|min:3|max:100',
